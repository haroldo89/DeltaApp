function Report3Index() { }

Report3Index.initializeComponents = function () {
    ...
    $("#btnGenerateReport").click(function (event) {
        ...
        setTimeout(function () {
            Report3Index.btnSave_Click(event);
        }, 500);
...
Report3Index.getReport = function () {
    var urlPage = '/Report3/GenerateAndDisplayReport';
    var dataParameters = {
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            Report3Index.getGoalConfiabilityOptions_onError(jqXHR, textStatus, errorThrown);
        }
    });
}


Report3Index.getGoalConfiabilityOptions_onError = function (jqXHR, textStatus, errorThrown) {
...
Report3Index.sendData = function () {
    var dataParameters = {
