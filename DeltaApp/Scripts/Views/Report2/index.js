function Report2Index() { }

Report2Index.initializeComponents = function () {
    ...
    $("#btnGenerateReport").click(function (event) {
        ...
        setTimeout(function () {
            Report2Index.btnSave_Click(event);
        }, 500);
...
Report2Index.getReport = function () {
    var urlPage = '/Report2/GenerateAndDisplayReport';
    var dataParameters = {
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            Report2Index.getGoalConfiabilityOptions_onError(jqXHR, textStatus, errorThrown);
        }
    });
}


Report2Index.getGoalConfiabilityOptions_onError = function (jqXHR, textStatus, errorThrown) {
...
Report2Index.sendData = function () {
    var dataParameters = {
