...
RolIndex.loadProductsByUserRolePopUp = function (selectedUserRoleId, selectedUserRoleName) {
    $("#divUserRoleProductsPopup").dialog({
        ...
        buttons: [
            {
                id: "btnDisassociateUserRoleProduct",
                text: "Desvincular Productos",
                "class": "buttonDialog",
                click: function () {
                    UserRolByProductPopUp.btnDisassociateUserRoleProduct_Click(selectedUserRoleId);
                }
            },
            {
                text: "Guardar",
                ...
                click: function () {
                    UserRolByProductPopUp.btnSaveEventCategories_Click(selectedUserRoleId);
                }
            },
            {
                text: "Cancelar",
