...
namespace DeltaApp.Controllers
{
    public class RolController : Controller
    {
        ...
        public ActionResult GetProductsByUserRole(string userRoleId = "0")
        {
            try
            {
                ...
                else
                {
                    ...
                    List<System.Web.Mvc.SelectListItem> products = this.ProductRepository.spGetUserRoleProducts(Convert.ToInt32(userRoleId))
        ...
        public ActionResult AssociateUserRoleProducts(int userRoleId, string productIds)
        {
            ...
            try
            {
                //resultMessage = this.ViewEventCategoryLabelBll.TryAdd(userRoleId, productIds);
